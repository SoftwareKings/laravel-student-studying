...
<?php if(count($popular_courses) > 0): ?>
    <section id="popular-course 1" style="margin-top: 4rem;" class="popular-course-section <?php echo e(isset($class) ? $class : ''); ?>">
        <div class="container">
    ...
    <!-- End popular course
        ============================================= -->
<?php endif; ?>
<?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/frontend/layouts/partials/popular_courses.blade.php ENDPATH**/ ?>