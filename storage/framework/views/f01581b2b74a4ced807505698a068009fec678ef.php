...
<div class="card">
    <div class="card-header">
        ...
        <div class="float-right">
            <a href="<?php echo e(route('admin.charts.index')); ?>" class="btn btn-success">View Charts</a>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="logic_tree question_tree" style="display:none">
                <ul class="treecontent">
                    <?php for($q=0; $q<count($course_list); $q++): ?> <li>
                        <?php echo e($course_list[$q]['title']); ?>

                        <ul>
                            <?php for($r=0; $r<count($course_test_list[$q]); $r++): ?> <li>
                                ...
                                <ul>
                                    ...
                                    <li class="type-<?php echo e($question_item['questiontype']); ?>" data-testid="<?php echo e($tk); ?>" data-value="<?php echo e(strip_tags($question_item['question'])); ?>" onclick='selectMatrixQuestion(event,this.getAttribute("data-value"))'><?php echo e($question_item['id'] .'.'. strip_tags($question_item['question'])); ?>
                                        ...
                                        <span>[<?php echo e($qtypes[$question_item['questiontype']]); ?>]</span><?php echo $score_htm.$is_condition_logic; ?>
            ...
            <div class="logic_tree textgroup_tree" style="display:none">
                <ul class="treecontent">
                    <?php for($i=0;$i<count($course_list);$i++): ?> <li>
                        <?php echo e($course_list[$i]['title']); ?> </a>
                        <ul>
                            <?php for($j=0;$j<count($course_test_list[$i]);$j++): ?> <li>
                                ...
                                <ul>
                                    ...
                                    <?php for($k=0;$k<count($textgroup_list[$tk]);$k++): ?> <li>
            ...
            <div class="row main-content" id="matrix_part">
                <div class="col-12" id="mat_set">
                    <div class="col-12">
                        ...
                        <div>
                            <!-- id="col_add" ov-changes -->
                            <a id="ccol_add" class="btn btn-success" style="color:white; margin-top:10px;">+ Add Column</a>
                        </div>
                    </div>
                    <div id="col_panel" class="col-12" style="padding-top:10px;">
                        ...
                        <?php for($k=1;$k< count($current_content[0]);$k++): ?> <div class="row">
                            <div class="col-2">
                ...
                <div class="col-12">
                    ...
                    <div>
                        <!-- id="row_add" ov-changes -->
                        <a id="crow_add" class="btn btn-success" style="color:white; margin-top:10px;">+ Add Row</a>
                    </div>
                </div>
                <div id="row_panel" class="col-12" style="padding-top:10px;">
                    ...
                    <?php for($i =1;$i<count($current_content);$i++): ?> <div class="row">
                        <div class="col-2">
                            <select class="form-control input-small select2me" data-placeholder="Select..." disabled>
                                <option>Single Input</option>
                                <option>Checkbox</option>
        ...
        <div class="col-12" style="padding-top:3vh;">
            ...
            <table id="real_matrix" width="100%">
                <tr>
                    ...
                    <?php for($j=1;$j<count($current_content[0]);$j++): ?> <td><input type="text" placeholder="" class="form-control head" value="<?php echo e($current_content[0][$j]); ?>" disabled=""></td>
                        <?php endfor; ?>
                </tr>
                <?php for($i=1;$i<count($current_content);$i++): ?> <tr>
                    <td width="15%"><input type="text" placeholder="" class="form-control head" value="<?php echo e($current_content[$i][0]); ?>" disabled=""></td>
                    <?php for($j=1;$j<count($current_content[0]);$j++): ?> <?php
                                                                    $idx = $j . "_" . $i;
                ...
                <div class="logic_condition row clone_condition" style="padding-top:10px;">
                    ...
                    <div class="col-5">
                        ...
                        <select class="form-control btn-warning" id="chart_type" placeholder="Options">
                            ...
                            ?>
                            <?php for($i=0;$i<count($types);$i++): ?> <?php if($current_chart->type == $i): ?>
                    ...
                    <div class="col-4">
                        <a id="create_chart" class="btn btn-primary" style="color:white">Create Chart</a>
                        <a id="save_data" class="btn btn-danger" style="color:white">Update Data</a>
                        <a id="save_options" class="btn btn-success" style="color:white">Save Options</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/backend/charts/edit.blade.php ENDPATH**/ ?>