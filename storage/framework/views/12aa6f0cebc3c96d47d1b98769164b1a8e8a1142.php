...
<div id="matrix_part" class="row question-box" <?php if(isset($display)): ?> style="display:<?php echo e($display); ?>;" <?php endif; ?>>
    ...
    <!-- Bilal Code -->
        ...
        <?php if(isset($question) && strpos($question->content,"table ")): ?>
        ...
        <table id="add-matrix" name="matrix"  matrix-type="[type]" data-id="[q_id]" class="table table-striped">
...
<?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/backend/questions/components/simple/matrix.blade.php ENDPATH**/ ?>