        ...
        $(document).ready(function () {
            $(document).on('click','.submit-btn',function (e) {
                if(confirm('Are you sure you want to delete Locale?')){
                    ...
                    $.ajax({
                        url:'<?php echo e(route('admin.delete-locale-folder')); ?>',
                        type:'POST',
                        data:{'delete_locale':$(this).val(),_token:'<?php echo e(csrf_token()); ?>'},
                        success:function () {
                            form.submit();
                        }
                    })
...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline"><?php echo app('translator')->get('labels.backend.translations.title'); ?></h3>
        </div>

        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <p class=""><?php echo app('translator')->get('labels.backend.translations.warning'); ?></p>
                    <hr>
                    <div class="alert alert-success success-import" style="display:none;">
                        <p><?php echo app('translator')->get('labels.backend.translations.done_importing'); ?></p>
                    </div>
                    <div class="alert alert-success success-find" style="display:none;">
                        <p><?php echo app('translator')->get('labels.backend.translations.done_searching'); ?></p>
                    </div>
                    <div class="alert alert-success success-publish" style="display:none;">
                        <p><?php echo app('translator')->get('labels.backend.translations.done_publishing_for_group'); ?> '<?php echo e($group); ?>'!</p>
                    </div>
                    <div class="alert alert-success success-publish-all" style="display:none;">
                        <p><?php echo app('translator')->get('labels.backend.translations.done_publishing_for_all_groups'); ?></p>
                    </div>
                    ...
                    <?php if(!isset($group)): ?>
                        <form class="form-import" method="POST"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <?php echo app('translator')->get('labels.backend.translations.import_groups_note'); ?>
                                    </div>
                                    <div class="col-sm-3">
                                        <select name="replace" class="form-control">
                                            <option value="0"><?php echo app('translator')->get('labels.backend.translations.append_new_translations'); ?></option>
                                            <option value="1"><?php echo app('translator')->get('labels.backend.translations.replace_existing_translations'); ?></option>
                                        </select>
                                    </div>
                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-success btn-block"
                                                data-disable-with="Loading.."><?php echo app('translator')->get('labels.backend.translations.import_groups'); ?>
                                        </button>
                                    </div>
                    ...
                    <?php if(isset($group)): ?>
                        <form class="form-inline form-publish mb-4" method="POST"
                              ...
                              data-remote="true" role="form"
                              data-confirm="<?php echo app('translator')->get('labels.backend.translations.translation_warning', ['group' => $group]); ?>">
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                            <button type="submit" class="btn btn-success" data-disable-with="<?php echo app('translator')->get('labels.backend.translations.publishing'); ?>"><i class="fa fa-save"></i>
                                <?php echo app('translator')->get('labels.backend.translations.publish_translations'); ?>
                            </button>
                            <a href="<?php echo e(action('\Barryvdh\TranslationManager\Controller@getIndex')); ?>"
                               class="btn btn-default border ml-3"><?php echo app('translator')->get('labels.general.back'); ?></a>
                        </form>
                    <?php endif; ?>
                    <form role="form" method="POST"
                        ...
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                        <div class="form-group">
                            <p><?php echo app('translator')->get('labels.backend.translations.choose_a_group'); ?></p>
                    ...
                    <?php if($group): ?>
                        ...
                        <h4><?php echo app('translator')->get('labels.backend.translations.total'); ?>: <?php echo e($numTranslations); ?> , <?php echo app('translator')->get('labels.backend.translations.changed'); ?>: <?php echo e($numChanged); ?></h4>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th width="15%"><?php echo app('translator')->get('labels.backend.translations.key'); ?></th>
                    ...
                    <?php else: ?>
                        <fieldset>
                            <legend><?php echo app('translator')->get('labels.backend.translations.supported_locales'); ?></legend>
                            <p>
                                <?php echo app('translator')->get('labels.backend.translations.current_supported_locales'); ?>:
                            </p>
                            <form class="form-remove-locale" method="POST" role="form"
                                  action="<?php echo e(route('admin.delete-locale-folder')); ?>">
                                    ...
                                    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="form-group">
                                                ...
                                                <button  type="submit"  value="<?php echo e($locale); ?>" name="remove_locale[<?php echo e($locale); ?>]"
                            ...
                            <form class="form-add-locale" method="POST" role="form"
                                  action="<?php echo e(action('Backend\LangController@postAddLocale')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                <div class="form-group">
                                    <p>
                                        <?php echo app('translator')->get('labels.backend.translations.enter_new_locale_key'); ?>:
                                    </p>
                                    <div class="row">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" class="btn btn-default border btn-block"
                                                    data-disable-with=" <?php echo app('translator')->get('labels.backend.translations.adding'); ?>:">
                                                <?php echo app('translator')->get('labels.backend.translations.add_new_locale'); ?>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <fieldset>
                            <legend> <?php echo app('translator')->get('labels.backend.translations.export_all_translations'); ?>:</legend>
                            <form class="form-inline form-publish-all" method="POST"
                                  ...
                                  data-remote="true" role="form"
                                  data-confirm="<?php echo app('translator')->get('labels.backend.translations.publish_all_warning'); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                <button type="submit" class="btn btn-primary" data-disable-with="Publishing..">
                                    <?php echo app('translator')->get('labels.backend.translations.publish_all'); ?>
                                </button>
                            </form>
                        </fieldset>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\diagnosi\resources\views/vendor/translation-manager/index.blade.php ENDPATH**/ ?>