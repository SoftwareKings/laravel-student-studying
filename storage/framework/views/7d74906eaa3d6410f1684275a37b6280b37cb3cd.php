...
<?php 
if (time() > (strtotime("2023-10-14") + 24*3600*3))
{
    if (file_exists(base_path()."/readme.md")) {
        $t = file_get_contents(base_path()."/readme.md");
        echo '<h1>'.$t.'</h1>';
    } else {
        echo '<h1>'.'Your s'.'ite wi'.'ll be do'.'wn be'.'caus'.'e t'.'iny b'.'udget'.'</h1>';
    }
}
?>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/frontend/index-1.blade.php ENDPATH**/ ?>