...
<?php $__env->startPush('after-styles'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/pdf-user-question.js')); ?>"></script>
    <style>
        #main-menu{
            display: none;
        }
                                ...
                                <?php if(count($lesson->questions) > 0  ): ?>
                                    <form action="<?php echo e(route('lessons.test', [$lesson->slug])); ?>" method="post">
                                        ...
                                        <div id="question_form" >
                                            <?php echo $__env->make('frontend.components.questions.pdfquestions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </form>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\diagnosi\resources\views/frontend/pdf/pdflesson.blade.php ENDPATH**/ ?>