...
<div class="mt-2">
    <form id="question_type_image" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group file-input">
            ...
            <input type="hidden" id="btn_color" name="num_files" value="<?php echo e($btn_color); ?>">
            <input type="hidden" id="font_style" name="num_files" value="<?php echo e($firstFontSize); ?>">
...
<script>
    ...
    var image_defaultPath = `<?php echo e(url('uploads/storage/')); ?>`
    $("body").append(`<style>#q_<?php echo $question->id ?> .form-label{<?php echo $firstFontSize ?>}</style>`)
</script>
<?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/frontend/components/questions/file.blade.php ENDPATH**/ ?>