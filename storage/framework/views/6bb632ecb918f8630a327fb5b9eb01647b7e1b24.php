    ...
    <div class="col-12">
       ...
       <?php endif; ?>
        <div class="mb-3">
            ...
            <input type="color" name="color1" id="color1" class="form-control" <?php if(isset($color)): ?>value="<?php echo e($color); ?>"<?php endif; ?>>
        </div>

        <div class="mb-3">
            <label for="color2">Color 2</label>
            <input type="color" name="color2" id="color2" class="form-control" <?php if(isset($color2)): ?>value="<?php echo e($color2); ?>"<?php endif; ?>>
        </div>
    </div>
    <div class="col-12">
        ...
        <?php if(isset($content)): ?>
           ...
           ?>
       <?php endif; ?>
        <?php $disp_len = 5; $min = 3; ?>
        <select name="display_rating" class="form-control" id="display_rating">
            <?php for($i = 1; $i <= $disp_len; $i++): ?>
                <option value="<?php echo e('col-'.$min*$i); ?>" <?= empty($display) || (isset($display) && $display == "none" && $i == 5) ?  'selected' : ''  ?> <?php if(isset($display)): ?><?php if($i == $display): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($i); ?></option>
            <?php endfor; ?>
        </select>
    </div>
...
<?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/backend/questions/components/simple/rating.blade.php ENDPATH**/ ?>