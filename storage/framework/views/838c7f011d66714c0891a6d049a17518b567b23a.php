                                        ...
                                        <?php if($lesson->model && $lesson->model->published == 1): ?>
                                            ...
                                            <div class="panel position-relative">
                                                        ...
                                                        <?php 
                                                            ...
                                                            // }
                                                        ?>
                                                            <span class="gradient-bg p-1 text-white font-weight-bold completed" style="border-radius: 0 0 0 4px!important;"><?php if($percent == '100'): ?> <?php echo app('translator')->get('labels.frontend.course.completed'); ?> <?php else: ?> <?php echo e(min(100, round($percent))); ?>% <?php endif; ?></span>
                                                        </div>
                                                ...
                                                <div id="collapse<?php echo e($count); ?>" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <div class="panel-body">
                                                        <?php if($lesson->model_type == 'App\Models\Test'): ?>
                                                            <?php echo e(mb_substr($lesson->model->description,0,150).'...'); ?>

                                                        <?php else: ?>
                                                            <?php if($lesson->model->live_lesson): ?>
                                                            <?php echo e(mb_substr($lesson->model->short_text,0,150).'...'); ?>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/frontend/courses/course.blade.php ENDPATH**/ ?>