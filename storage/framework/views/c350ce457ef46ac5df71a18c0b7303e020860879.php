...
<script>
    ...
    function inputToData(ele){
        if(ele.type == 'radio'){
            ...
            var italicFrom  = 0;
            if(ele.value != 0){
                italicFrom  = convertNumberFormat(ele.value);
            }
            // alert(ele)
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/frontend/components/questions/questions.blade.php ENDPATH**/ ?>