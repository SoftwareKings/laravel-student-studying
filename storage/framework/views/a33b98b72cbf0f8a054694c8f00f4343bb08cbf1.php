                        ...
                        <?php if(auth()->user()->hasRole('student')): ?>
                            ...
                            <?php if(count($purchased_courses) > 0): ?>
                                <?php $__currentLoopData = $purchased_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('courses.show', [$item->slug])); ?>">
                                        <div class="col-md-3">
                                            <div class="best-course-pic-text pt-0 position-relative border">
                                                    ...
                                                    <div class="course-meta d-inline-block w-100 ">
                                                        <div class="d-inline-block w-100 0 mt-2">
                                                            <span class="course-category float-left">
                                                                ...
                                                                class="bg-success text-decoration-none px-2 p-1"><?php echo e($item->category->name == 'study' ? 'Checkup' : $item->category->name); ?></a>
                                                            </span>
                                                        ...
                                                        <div class="progress my-2">
                                                            <div class="progress-bar"
                                                                style="width:<?php echo e($item->progress()); ?>%; background-color: #18149b;">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/backend/dashboard.blade.php ENDPATH**/ ?>