...
<div class="single-input">
    <div class="mb-2">
        <input type="text" class="form-control" id="<?php echo e($question->id); ?>" name="single_input[]" placeholder="Write your answer" <?php if($question->required): ?> required <?php endif; ?> style="<?php 
            if(isset($question)){
    ...
    <?php endif; ?> -->
</div><?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/frontend/components/questions/single_input.blade.php ENDPATH**/ ?>