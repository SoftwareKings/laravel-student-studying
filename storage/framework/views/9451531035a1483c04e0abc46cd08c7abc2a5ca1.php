...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-12">
                    <h3 class="page-title d-inline"><?php echo app('translator')->get('labels.backend.sitemap.title'); ?></h3>
                    <a class="btn btn-primary pull-right" href="<?php echo e(route('admin.sitemap.generate')); ?>"><?php echo app('translator')->get('labels.backend.sitemap.generate'); ?></a>
        ...
        <div class="card-body" id="newsletter">
            <h5><?php echo app('translator')->get('labels.backend.sitemap.sitemap_note'); ?></h5>
         ...
         ->class('form-control ')); ?>
                    ...
                    <span><?php echo app('translator')->get('labels.backend.backup.backup_note'); ?></span>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/backend/sitemap/index.blade.php ENDPATH**/ ?>