            ...
            $("#order_change").on('click',function(e){
                ...
                e.preventDefault();
                    $.ajax({
                        ...
                        url: '<?php echo e(route('admin.courses.position-reorder')); ?>',
                        type: 'get',
                        dataType: 'json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FreelancerTask\Laravel\diagnosi12_05_01\resources\views/backend/courses/index.blade.php ENDPATH**/ ?>