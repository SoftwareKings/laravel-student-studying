...
<b>Live</b> = Will be used with you Live PayUMoney credentials to make actual transaction with normal users with PayUMoney account.<br><strong>If you set this payment gateway then set your currency as INR</strong>',
      ...
      'admin_report_mail' => 'Report Mail',
      'admin_report_mail_note' => 'Enable / Disable if admin will be able to received new report mail',
      'newsletter' => 
      array (
    ...
    array (
      'title' => 'Subscription',
      'no_invoice' => 'You have not subscribe any plan',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'primary' => 'Primary',
        'second' => 'Second',
        'my_label_contact' => 'Email',
        'my_label_contact_phone' => 'Phone',
