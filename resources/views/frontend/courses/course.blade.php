                                            ...
                                            <div class="panel position-relative">
                                                {{-- @if(auth()->check())
                                                    @if(in_array($lesson->model->id,$completed_lessons)) --}}
                                                        ...
                                                        @php 
                                                            ...
                                                            // }
                                                        @endphp
                                                            <span class="gradient-bg p-1 text-white font-weight-bold completed" style="border-radius: 0 0 0 4px!important;">@if($percent == '100') @lang('labels.frontend.course.completed') @else {{min(100, round($percent))}}% @endif</span>
                                                        </div>
                                                    {{-- @endif
                                                @endif --}}
                                                    ...
                                                    <div class="ac-head">
                                                        ...
                                                        @if($lesson->model_type == 'App\Models\Test')
                                                            <div class="leanth-course">
                                                                <a class="btn btn-sm btn-default" href="{{route('lessons.show',['course_id' => $lesson->course->id,'slug'=>$lesson->model->slug,'test_id'=>$lesson->model->id])}}">
                                                        ...
                                                        @if($lesson->model->live_lesson)
                                                            <div class="leanth-course">
                                                                <a class="btn btn-sm btn-default" href="{{route('lessons.show',['course_id' => $lesson->course->id,'slug'=>$lesson->model->slug,'test_id'=>$lesson->model->id])}}">
                                                                    @lang('labels.frontend.course.live_lesson')
                                                                </a>
                                                            </div>
                                                        @endif
                                                    </div>
                                                ...
                                                <div id="collapse{{$count}}" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <div class="panel-body">
                                                        @if($lesson->model_type == 'App\Models\Test')
                                                            {{ mb_substr($lesson->model->description,0,150).'...'}}
                                                        @else
                                                            @if($lesson->model->live_lesson)
                                                            {{ mb_substr($lesson->model->short_text,0,150).'...'}}
                                                            @else
                                                            ...
                                                            @if(in_array($lesson->model->id,$completed_lessons)) --}}
                                                                <div>
                                                                    <a class="btn btn-default mt-3"
                                                                       href="{{route('lessons.show',['course_id' => $lesson->course->id,'slug'=>$lesson->model->slug,'test_id'=>$lesson->model->id])}}">
