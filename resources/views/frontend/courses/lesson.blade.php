...
{{--<link rel="stylesheet" href="{{asset('plugins/YouTube-iFrame-API-Wrapper/css/main.css')}}">--}}
    ...
    <script type="text/javascript" src="{{asset('js/user-question.js')}}?t={{ time() }}"></script>
    <style>
        #report {
            position: relative;
            margin: auto;
        ...
        .course-timeline-list > .active{
            background-color: #e6e6e6!important;
            border: none;
        }

        .course-details-category li:hover{
            background: linear-gradient(to right, #2a0845 0%, #6441A5 51%, #2a0845 100%)!important
        }
    </style>
@endpush
           ...
           {{-- Progress Bar --}}
            ...
            <div class="row w-100  justify-content-md-center mb-5">
                <div class="b_progress_container">
                    <div class="b_progress_bar gradient-bg" style="width:min({{ $percent }}%, 100%);">
                        
                    </div>
                    <div class="b_progress gradient-bg" style="left: max(0px, calc(min({{ $percent }}%, 100%) - 4%));">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-3">
                                    ...
                                    <li class="@if($lesson->id == $item->model->id) active @endif ">
                                        <a @if(in_array($item->model->id,$completed_lessons))href="{{route('lessons.show',['course_id' => $lesson->course->id,'slug'=>$item->model->slug])}}"@endif>
                                            ...
                                            @if(in_array($item->model->id,$completed_lessons)) <i
                                                    class="fas float-right fa-check-square"></i> @endif
                                        </a>
                                    </li>
                                @endif
                ...
                {{-- <div id="sidebar" class="sidebar mt-5">
                    <div class="card-body">
                        <!-- <span class="float-none">Help </span> -->
