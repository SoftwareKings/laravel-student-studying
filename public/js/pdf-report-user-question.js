...
function sendPageAsHtml() {
    // alert('asd');
      // Disable mouse and keyboard interactions on the page
        // $(document).on('mousedown', disableEvent);
        // $(document).on('keydown', disableEvent);
    $('#loader').hide();
...
// console.log(imageData);
    // Set the image data to the hidden input field in the form
